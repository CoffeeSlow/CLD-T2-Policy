...
$Host.UI.RawUI.WindowTitle = "CLD Scanner"
...
function Write-BoxedHeader {
    ...
    if ($Subtitle) {
        ...
        Write-Host "|" -NoNewline -ForegroundColor Cyan
        Write-Host ($leftPadding + $Subtitle + $rightPadding) -NoNewline -ForegroundColor White
        Write-Host "|" -ForegroundColor Cyan
    }
    Write-ColoredLine $border Cyan
    Write-Host ""
...
Clear-Host
Write-Host ""
Write-Host "  ____ _     ____    _____ ____    ____   ___  _     ___ ______   __" -ForegroundColor Gray
Write-Host " / ___| |   |  _ \  |_   _|___ \  |  _ \ / _ \| |   |_ _/ ___\ \ / /" -ForegroundColor Gray
Write-Host "| |   | |   | | | |   | |   __) | | |_) | | | | |    | | |    \ V / " -ForegroundColor Gray
Write-Host "| |___| |___| |_| |   | |  / __/  |  __/| |_| | |___ | | |___  | |  " -ForegroundColor Gray
Write-Host " \____|_____|____/    |_| |_____| |_|    \___/|_____|___\____| |_|  " -ForegroundColor Gray
Write-Host ""
Write-ColoredLine "============================================================" Cyan
Write-ColoredLine "   discord.gg/cldx" White
Write-ColoredLine "============================================================" Cyan
Write-Host ""
Write-ColoredLine "=== CLD T2 POLICY ===" Cyan
...
if ($cpu -and $cpu.NumberOfCores -ge 4 -and $cpu.MaxClockSpeed -ge 2500) {
    ...
    Write-ColoredLine "May experience slower scans" Yellow
}
Write-Host ""
...
Write-ColoredLine "Created by CLD Justice Department" Blue
Write-Host ""
...
$suspiciousFiles = @(
    ...
    "volcano exploit", "isaeva exploit", "synapse z exploit", "velocity exploit",
    "seliware exploit", "bunni.fun exploit", "sirhurt exploit", "solara exploit", "xeno exploit",
...
$watchlist = @(
    ...
    "VOLT.EXE", "POTASSIUM.EXE", "WAVE.EXE", "COSMIC.EXE",
    "VOLCANO.EXE", "ISAEVA.EXE", "SYNAPSEZ.EXE", "VELOCITY.EXE",
    "SELIWARE.EXE", "BUNNI.EXE", "SIRHURT.EXE", "SOLARA.EXE", "XENO.EXE",
